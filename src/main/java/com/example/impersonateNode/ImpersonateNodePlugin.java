 ...
 * @since AM 5.5.0
 */
public class ImpersonateNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(ImpersonateNodePlugin.currentVersion,
                Collections.singletonList(ImpersonateNode.class));
    }
    ...
    public String getPluginVersion() {
        return ImpersonateNodePlugin.currentVersion;
    }
}
